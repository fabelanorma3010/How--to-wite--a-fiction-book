...
/**
 * "Continue with Google" — starts the Supabase OAuth flow, which redirects the
 * browser to Google and then back to /auth/callback. `next` is where the user
 * lands once the session is set.
 */
export default function GoogleButton({
  ...
  async function handleClick() {
    ...
    // On success the browser is already navigating to Google — leave `loading` on.
  }
